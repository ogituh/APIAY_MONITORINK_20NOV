                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="d-flex px-2 py-1">
                                <div>
                                    <img src="{{ asset('img/small-logos/logo-xd.svg') }}" class="avatar avatar-sm me-3"
                                        alt="xd">
                                </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="avatar-group mt-2">
                                ...
                                <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                                    data-bs-placement="bottom" title="Jessica Doe">
                                    <img src="{{ asset('img/team-3.jpg') }}" alt="team9">
                                </a>
                            </div>
                        </td>
                        <td class="align-middle text-center text-sm">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="avatar-group mt-2">
                                ...
                                <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                                    data-bs-placement="bottom" title="Romina Hadid">
                                    <img src="{{ asset('img/team-4.jpg') }}" alt="user2">
                                </a>
                                <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                                    data-bs-placement="bottom" title="Alexander Smith">
                                ...
                                <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                                    data-bs-placement="bottom" title="Jessica Doe">
                                    <img src="{{ asset('img/team-4.jpg') }}" alt="user4">
                                </a>
                            </div>
                        </td>
                        <td class="align-middle text-center text-sm">
                    ...
                    <tr>
                        <td>
                            <div class="d-flex px-2 py-1">
                                <div>
                                    <img src="{{ asset('img/team-4.jpg-jira.svg')}}" class="avatar avatar-sm me-3"
                                        alt="jira">
                                </div>
                                <div class="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="avatar-group mt-2">
                                ...
                                <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip"
                                    data-bs-placement="bottom" title="Jessica Doe">
                                    <img src="{{ asset('img/team-1.jpg') }}" alt="user7">
                                </a>
                            </div>
                        </td>
                        <td class="align-middle text-center text-sm">
